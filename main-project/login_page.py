...
class Login_win:
    def __init__(self,root):
        ...
        b=Button(lbimg,text="Back",font=("Arial bold",10),bg="#FFECD1",fg="#141413")
...
class Register_win:
    def __init__(self,root):
        ...
        checkbtn.place(x=335,y=400)
         ...
         #==========================Buttons =========
        self.b=Button(lbimg,text="BACK",font=("Arial bold",10),bg="#FFECD1",fg="#141413")
...
class Hotel:
    def __init__(self,root):
        ...
        LOGOUT=Button(lbimg,text="LOGOUT",bg="#d4a97f",fg="#044d72",font=("Arial bold",15))
